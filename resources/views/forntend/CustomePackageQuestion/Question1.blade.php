                            ...
                            <div class="p-y w-auto border-2 border-purple-600 h-auto rounded-3xl flex flex-col shadow-lg">
                                ...
                                <div class="bg-purple-600 flex  w-100 py-4 px-6">
                                    <!-- <h1 class="nexa_light text-base	text-white">Only</h1> -->
                                        ...
                                        <li class="roboto-bold  text-white flex justify-between"><span>Santa Package Selected:</span><span><span class="add-total-{{ $question->id }} add-total">${{ round($percentage, 0); }}</span> (<span class="add-precentage add-precentage-{{ $question->id }}">@if($question->id == 1) 2% @else 2% @endif</span>)</span>   </li>    
                                        <?php $price = $inquiryee->admin_price - $percentage ?>
                                        <input type="hidden" class="mobile-inside-price-{{ $question->id }} price" value="{{$price }}">

                                        <li class="roboto-bold  text-white flex justify-between"><span>Take Home:</span> 
<span class="mobile-inside-price-{{ $question->id }} price">{{  round($price, 0)  }}$</span></li>    
                                      </ul>
                                </div>
                                <div class="leftcell">
...
<span class="mobile-inside-price-{{ $question->id }} price">{{ $inquiryee->admin_price - 20 }}$</span></li>    
                                ...
                                <div class="leftcell">
                                    ...
                                    <ul class="mt-4 px-4 nexa_light text-lg">
                                        ...
                                        <li class="px-4 py-2 ">Upload staging photos for your rental unit in our cloud</li>
